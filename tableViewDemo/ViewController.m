...
-(void)addTableView {
    ...
    [self.tableView registerClass:[ItemCell class] forCellReuseIdentifier:cellIdentifier];
...
-(void)updateDetail:(NSDictionary *)details {
    ...
    if ([details objectForKey:@"rows"]) {
        self.tableItems = nil;
        self.tableItems = [Model getModelArrayFromJson:[details objectForKey:@"rows"]];
    }
